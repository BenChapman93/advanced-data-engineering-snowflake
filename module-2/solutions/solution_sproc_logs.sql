...
# Set up basic logging
    ...
    try:
        ...
        telemetry.add_event("query_begin", {"description":"Starting to query order_headers_stream"})
        ...
        telemetry.add_event("query_complete", {"description":"Completed query of orders_headers_stream"})
